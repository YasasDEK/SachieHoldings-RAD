                		...
                		<div class="login-form">
							...
							<form action="insert.php" method="post">
								<div class="name">
									<div class="row">
										<div class="col-md-6">
											<input type="text" name="drvFirstName" placeholder="First Name">
										</div>
										<div class="col-md-6">
											<input type="text" name="drvLastName" placeholder="Last Name">
										</div>
									</div>
								</div>
                                <div class="username">
                                    <input type="text" name="drvNIC" placeholder="NIC">
                                </div>
								<div class="username">
									<input type="email" name="drvEmail" placeholder="Email">
								</div>
                                <div class="username">
                                    <input type="text" name="drvDOB" placeholder="Date of birth (yyyy-mm-dd)">
                                </div>
                                <div class="username">
                                    <input type="text" name="drvAddress" placeholder="Address">
                                </div>
                                <div class="username">
                                    <input type="text" name="drvLicense" placeholder="License number">
                                </div>
                                <div class="name">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" name="drvMobile" placeholder="Mobile">
                                        </div>
                                        <div class="col-md-6">
								...
								<div class="password">
									<input type="password" name="drvPassword" placeholder="Password">
								</div>
                                <div class="password">
                                    <input type="password" name="drvCpass" placeholder="Confirm password">
                                </div>
                               <!-- <div class="password">
                                    <form action="myform.cgi"> <input type="file" name="drvPhoto" value="fileupload" id="fileupload"> <label for="fileupload">Add a user's photo (Select a file to upload)</label>
                                </div>
                                <div class="password">
                                    <form action="myform.cgi"> <input type="file" name="drvLicensePhoto" value="fileupload" id="fileupload"> <label for="fileupload">Add a photo of driver's license (Select a file to upload)</label>
                                </div>-->
                                <div class="password">
                                    <input type="text" name="drvNIC" placeholder="Adimn NIC">
                                </div>                                
								<div class="log-btn">
