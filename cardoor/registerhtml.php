                		...
                		<div class="login-form">
							...
							<form action="registerphp.php" method="post">
                                ...
                                <div class="name">
                                    ...
                                    <div class="password">
                                    <input type="file" name="drvPhoto" value="fileupload" id="fileupload" required> <label for="fileupload">Add a user's photo (Select a file to upload)</label>
                                </div>
                                <div class="password">
                                    <input type="file" name="drvLicensePhoto" value="fileupload" id="fileupload" required> <label for="fileupload">Add a photo of driver's license (Select a file to upload)</label>
                                </div>
                                <div class="password">
