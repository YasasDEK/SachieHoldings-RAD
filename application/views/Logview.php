                ...
                <div class="col-lg-4 col-md-8 m-auto">
                    <div class="login-page-content">
                        <div class="login-form">
                            <h3>Welcome Back!</h3>
                            <?php echo form_open('Logcontroller/login_validation'); ?>
                            <form method="post" action="">
                                <div class="username">
                                    <input type="text" name="drvNIC" placeholder="Username(NIC)" required>
                                    <span class="text-danger"><?php echo form_error('drvNIC');?></span>
                                </div>
                                <div class="password">
                                    <input type="password" name="drvPassword" placeholder="Password" required>
                                    <span class="text-danger"><?php echo form_error('drvPassword');?></span>
                                </div>
                                <div class="log-btn">
                        ...
                        <div class="create-ac">
                            <p>Don't have an account? <a href="http://[::1]/SYS/index.php/Regcontroller">Sign Up</a></p>
                        </div>
