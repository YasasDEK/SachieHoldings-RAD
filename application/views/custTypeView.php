                    ...
                    <div class="single-service-item">
                        ...
                        <div class="service-item-content">
							<?php
								...
								echo "<h3>". $rec->tyName. "</h3><p>Number of Passengers ". $rec->tyPassenger."</p><p>Rate ". $rec->tyDRate."</p><p>Weekly Rate ". $rec->tyWParcent."</p><p>monthly Rate ". $rec->tyMPercent."</p><p>Description ". $rec->tyDescription."<br>";
                                $id=$rec->tyID;
                                echo "<br>";
