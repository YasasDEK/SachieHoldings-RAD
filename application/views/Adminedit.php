    ...
    <form action="<?php echo site_url('Admincontroller/update') ?>" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                NIC Number : <input type="text" value="<?php echo $blog->drvNIC; ?>" placeholder="NIC" name="drvNIC" class="form-control" readonly>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                Emali : <input type="text" value="<?php echo $blog->drvEmail; ?>" placeholder="Email" name="drvEmail" class="form-control" required> </div>
        </div>
        ...
        <div class="form-group">
            <label for="description" class="col-md-1 text-right"></label>
            <div class="col-md-10">
                Driver Photo : <input type="text" value="<?php echo $blog->drvimg; ?>" placeholder="Photo" name="drvimg" class="form-control" readonly>
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="description" class="col-md-1 text-right"></label>
            <div class="col-md-10">
                Land Number :<input type="text" value="<?php echo $blog->drvLAND; ?>" placeholder="LAND" name="drvLAND" class="form-control" required>
            </div>
        </div>
        ...
        <div class="form-group">
            <label for="description" class="col-md-1 text-right"></label>
            <div class="col-md-10">
                Employee Number : <input type="text" value="<?php echo $blog->empNIC; ?>" placeholder="Employee" name="empNIC" class="form-control" required>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <a href="<?php echo site_url('Admincontroller'); ?>" class="btn btn-default">Back</a>
            </div>
        </div>
